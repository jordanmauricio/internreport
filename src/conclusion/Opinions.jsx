    ...
    render() {
        return (
            <div>
                ...
                <h2>FAQ</h2>
                <p><strong>What could've gone better? </strong></p>
                ...
                <p>Not exactly didn’t like, but it was a rude awakening to find out that even a company as well established and prominent as TRIMM still have some of the problems that even smaller companies suffer them. I can’t go into too-deep of detail here of course, but I had simply (incorrectly) assumed that the process of work and getting work is a lot smoother.</p>
                <p><strong>What does TRIMM do better? </strong></p>
                ...
                <p><strong>What would you tell students considering TRIMM? </strong></p>
                ...
                <p><strong>What kind of music were you listening to there?</strong></p>
                <ol>
                ...
                <p><strong>Did you learn anything outside of your professional life?</strong></p>
                <ol>
                ...
                <div className="button"><p><Link to="/conclusion/future">Future</Link></p></div>
            </div>
        );
    }
}
